...
extern "C" void disp_flush_c(lv_disp_drv_t *drv, const lv_area_t *area,
                             lv_color_t *color_p) {
...
void Display::disp_flush(lv_disp_drv_t *disp, const lv_area_t *area,
                         lv_color_t *color_p) {
...
void Display::set_brightness(uint8_t value) { this->tft->setBrightness(value); }
int32_t Display::get_brightness() { return (int32_t)this->tft->getBrightness(); }