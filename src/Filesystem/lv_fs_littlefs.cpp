...
void lv_port_littlefs_fs_init(void) {
    ...
    fs_drv.open_cb = littlefs_fs_open;
    fs_drv.close_cb = littlefs_fs_close;
    fs_drv.read_cb = littlefs_fs_read;
    fs_drv.write_cb = littlefs_fs_write;
    fs_drv.seek_cb = littlefs_fs_seek;
    fs_drv.tell_cb = littlefs_fs_tell;

    fs_drv.dir_close_cb = littlefs_dir_close;
    fs_drv.dir_open_cb = littlefs_dir_open;
    fs_drv.dir_read_cb = littlefs_dir_read;
