...
DockPanel::DockPanel(lv_obj_t *parent_panel) {
    ...
    lv_obj_set_style_text_font(WiFiLabel, &wifi_symbols_20,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(temperatureLabel, &lv_font_montserrat_20,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(humidityLabel, &lv_font_montserrat_20,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(settingsButtonLabel, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(settingsButtonLabel, &lv_font_montserrat_20,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
}
