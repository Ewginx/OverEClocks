...
void Settings::load_settings_screen(lv_obj_t *screen) {
    ...
    lv_scr_load_anim(this->ui_SettingsScreen, LV_SCR_LOAD_ANIM_FADE_ON,
...
void Settings::create_keyboard(lv_obj_t *target) {
    if (this->ui_SettingsKeyboard == NULL) {
        ...
        lv_obj_add_event_cb(this->ui_SettingsKeyboard, keyboard_event_cb_wrapper,
...
void Settings::delete_keyboard() {
    if (this->ui_SettingsKeyboard != NULL) {
        ...
        lv_obj_set_height(this->ui_SettingsPanel, this->_settings_panel_height);
...
void Settings::settings_city_edit_event_cb(lv_event_t *e) {
    ...
    if (event_code == LV_EVENT_FOCUSED || event_code == LV_EVENT_CLICKED) {
        lv_obj_set_height(this->ui_SettingsPanel, this->_settings_panel_height / 4);
        lv_obj_readjust_scroll(this->ui_SettingsScreen, LV_ANIM_OFF);
        lv_obj_scroll_to_y(this->ui_SettingsPanel,
    ...
    if (event_code == LV_EVENT_READY) {
        ...
        // lv_textarea_get_text(this->ui_SettingsCityEdit)); _preferences.end();
    }
}
...
void Settings::settings_password_edit_event_cb(lv_event_t *e) {
    ...
    if (event_code == LV_EVENT_READY) {
        ...
        // lv_textarea_get_text(ui_SettingsPasswordEdit)); _preferences.end();
    }
}
...
void Settings::init_settings_screen() {
    ...
    lv_obj_set_size(this->ui_SettingsPanel, lv_pct(100), this->_settings_panel_height);
    lv_obj_set_style_bg_color(this->ui_SettingsPanel, lv_color_hex(0xFFFFFF),
    ...
    lv_obj_align_to(this->brightnessSlider, this->ui_DarkmodeLabel,
    ...
    lv_obj_set_pos(this->ui_SettingsCityEdit, 180, this->_settings_panel_height / 5);
    lv_obj_set_align(this->ui_SettingsCityEdit, LV_ALIGN_TOP_LEFT);
    lv_textarea_set_max_length(this->ui_SettingsCityEdit, 100);
    lv_textarea_set_placeholder_text(this->ui_SettingsCityEdit,
    ...
    lv_obj_set_pos(this->ui_SettingsCityLabel, 20, this->_settings_panel_height / 5);
    ...
    lv_obj_set_style_text_font(this->ui_SettingsCityLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(this->ui_SettingsCityLabel, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(this->ui_SettingsSSIDEdit, 180, this->_settings_panel_height / 5 + 60);
    lv_obj_set_align(this->ui_SettingsSSIDEdit, LV_ALIGN_TOP_LEFT);
    lv_textarea_set_max_length(this->ui_SettingsSSIDEdit, 50);
    lv_textarea_set_placeholder_text(this->ui_SettingsSSIDEdit,
    ...
    lv_obj_set_pos(this->ui_SettingsSSIDLabel, 40, this->_settings_panel_height / 5 + 70);
    ...
    lv_obj_set_style_text_font(this->ui_SettingsSSIDLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(this->ui_SettingsPasswordEdit, 180,
    ...
    lv_textarea_set_placeholder_text(this->ui_SettingsPasswordEdit,
    ...
    lv_obj_set_size(this->ui_SettingsPasswordLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    lv_obj_set_pos(this->ui_SettingsPasswordLabel, 20,
                   this->_settings_panel_height / 5 + 65 * 2);
    lv_obj_set_align(this->ui_SettingsPasswordLabel, LV_ALIGN_TOP_LEFT);
    lv_label_set_text(this->ui_SettingsPasswordLabel,
                      settings_translation[wifi_password]);
    lv_obj_set_style_text_font(this->ui_SettingsPasswordLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(this->ui_SettingsAPLabel, 80, this->_settings_panel_height - 60);
    ...
    lv_obj_set_style_text_font(this->ui_SettingsAPLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(this->ui_SettingsIPLabel, 230, this->_settings_panel_height - 60);
    lv_obj_set_align(this->ui_SettingsIPLabel, LV_ALIGN_TOP_LEFT);
    lv_label_set_text(this->ui_SettingsIPLabel, "192.120.12.99");
    lv_obj_set_style_text_font(this->ui_SettingsIPLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(this->ui_SettingsHomeButtonLabel, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(this->ui_SettingsHomeButtonLabel, &lv_font_montserrat_20,
                               LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_add_event_cb(this->ui_SettingsCityEdit, settings_city_edit_event_cb_wrapper,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(this->ui_SettingsSSIDEdit, settings_SSID_edit_event_cb_wrapper,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(this->ui_SettingsPasswordEdit,
                        settings_password_edit_event_cb_wrapper, LV_EVENT_ALL, NULL);
    ...
    lv_obj_add_event_cb(this->autoBrightnessCheckbox,
                        ...
                        LV_EVENT_VALUE_CHANGED, NULL);
    lv_obj_add_event_cb(this->ui_SettingsHomeButton, home_button_event_cb_wrapper,
                        LV_EVENT_CLICKED, NULL);
}
Settings::~Settings() {
    // if (ui_SettingsScreen != NULL)
    // {
    //     lv_obj_remove_event_cb(this->ui_SettingsCityEdit,
    //     settings_city_edit_event_cb_wrapper);
    //     lv_obj_remove_event_cb(this->ui_SettingsSSIDEdit,
    //     settings_SSID_edit_event_cb_wrapper);
    //     lv_obj_remove_event_cb(this->ui_SettingsPasswordEdit,
    //     settings_password_edit_event_cb_wrapper);
    //     lv_obj_remove_event_cb(this->ui_SettingsHomeButton,
    //     home_button_event_cb_wrapper); this->ui_SettingsScreen = NULL;
