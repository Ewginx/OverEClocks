...
#if LANGUAGE == 1
    const char *settings_translation[] = {"Темная тема","Авто", "Moscow", "ru", "Город и код страны", "WiFi SSID", "WiFi SSID", "WiFi пароль", "WiFi пароль", "AccessPoint IP адрес:", "Переподключить WiFi", "API погоды включено"};
