#include "Translation/Translation.h"
...
#if LANGUAGE == 1
    const char *settings_translation[] = {"Темная тема","Авто", "Город, код страны ISO-81118", "Город и\nкод страны", "WiFi SSID", "WiFi SSID", "WiFi пароль", "WiFi пароль", "AccessPoint IP:"};
    ...
    const char *weather_translation[] = {"км/ч","По ощущениям","мбар", "Ночью           ", "Утром           ", "Днём           ", "Вечером"};
#endif
