...
DigitalClock::DigitalClock() {
    this->createDigitalClockWidgets();
    this->setDefaultValues();
};

void DigitalClock::createDigitalClockWidgets() {
    digitalClockScreen = lv_obj_create(NULL);
    lv_obj_clear_flag(digitalClockScreen, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_clear_flag(digitalClockPanel, LV_OBJ_FLAG_SCROLLABLE);
